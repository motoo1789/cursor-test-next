...
export const mockIcons = [
  ...
  },
  {
    id: 2,
    name: "Next.js Logo",
    url: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/nextdotjs.svg",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    url: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/javascript.svg",
  },
  {
    id: 5,
    name: "CSS Logo",
    url: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/css3.svg",
  },
  {
    id: 6,
    name: "Node.js Logo",
    url: "https://cdn.jsdelivr.net/npm/simple-icons@v9/icons/nodedotjs.svg",
  },
];
...
const generateMockArticles = (count: number): ArticleSummary[] => {
  ...
  for (let i = 1; i <= count; i++) {
    ...
    articles.push({
      ...
      published: Math.random() > 0.15, // 85%の記事を公開状態に（15%は非公開）
    });
  }
